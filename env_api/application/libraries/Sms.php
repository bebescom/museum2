...
//    require(PHPEXCEL_ROOT . 'PHPExcel/Autoloader.php');
    require_once PHPEXCEL_ROOT . 'Aliyun/vendor/autoload.php';
}
...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIUdWasG2zG3PQ"; // AccessKeyId

        $accessKeySecret = "EsKdnrZd5BnsgVMOP4USSZEqikpoDo"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone,$data=array(),$signName="智联预防性保护平台",$templateCode="SMS_130830395") {
...
//        $request->setSmsUpExtendCode("1234567");
     ...
     * @return stdClass
     */
    public static function sendBatchSms($phones=array(),$data=array(),$signNames=array(),$templateCode="	SMS_130914444") {
