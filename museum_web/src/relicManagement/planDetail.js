...
module.exports = {
    ...
    methods:{
        ...
        deletePlanHandler:function(){
            ...
            this.$Modal.confirm({
                ...
                onOk:function(){
                    $.ajax({
                        type:'GET',
                        url:API('/relics/inventorytask/delete/'+me.planId)+'?requestType=pc',
        ...
        getRelic:function(filterObj){
            ...
            $.get(API('/relics/inventoryDetail/list/'+this.page+'/'+this.limit)+'?requestType=pc',filter,function(res){
