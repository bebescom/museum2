    ...
    Vue.component('history-info', {
        ...
        methods: {
            init: function (equip) {
                ...
                $.get(API('/env/equipments/operation/filter') + '?equip_no=' + equip.equip_no, function (data) {
            ...
            get_data: function () {
                ...
                $.post(API('/env/equipments/detail/opt_record/' + _this.equip.equip_no), param, function (data) {
