// @require css/environment.css
// @require common/css/icon.css
// @require css/environment_map.css
// @require css/environment_relic.css
// @require css/environment_equipment.css
...
module.exports=Vue.extend({
	...
	ready:function(){
		...
		$.get(API('/base/envs/tree/'),{inc_equip:1},function(data){
			var filterContents=[];
	...
	components: {
	   environment_curve:require('./components/environment_curve'),
	   environment_data:require('./components/environment_data'),
	   environment_equipment:require('./components/environment_equipment'),
	   environment_map:require('./components/environment_map'),
	   environment_relic:require('./components/environment_relic')
	}
});
