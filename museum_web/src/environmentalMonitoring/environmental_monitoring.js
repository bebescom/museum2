// @require css/environmental_monitoring.css
// @require laydate
// @require echarts
...
module.exports = Vue.extend({
    ...
    created: function () {
        ...
        // $.get(API('/env/monitor/alerts/alerts_count'), function (data) {
    ...
    ready: function () {
        ...
        this.$shadow = $('.shadow');
        this.$shadow.show();
        $.get(API('/env/monitor/monitor_overview?time=' + this.timeStr), function (data) {
            This.$shadow.hide();
            if (data.error) {
        ...
        // $.get(API('/report/report'), function (data) {//导出生成报告（数据）
        ...
        //     });
        // });
        // $.get(API('/report/report'),{limit:10,page:1},function (data) {
    ...
    methods: {
        ...
        getLink: function (list) {
            if (!list) list = '';
            // $.get(API('/env/monitor/export'), {env_no: list, time: this.timeStr}, function (data) {
        ...
        reportData:function (thisPage) {
            var This=this;
            $.get(API('/report/report'),{limit:This.report_size,page:thisPage},function (data) {
                This.report_list=data.rows;
                This.report_total=data.total;
            })
        },
