...
function load_env(env_no) {
    ...
    if (env_no == "") {
        ...
        $.get(API("/base/envs/info/" + env_no), function (json) {
            // console.log(json);
            if (json&&json.error) {
    ...
    $.get(API('/base/envs'), param, function (data) {
        if (data&&data.error) {
...
function load_equip(env_no, opt) {
    ...
    EQUIPS = {};
    $.get(API('/env/common/equip_type'), function (json) {
        // console.log(json);
        if (json&&json.error) {
            vm.$Message.error(json.error);
            // alert(json.msg);
    ...
    $.get(API('/env/setting/no_locate/' + env_no), function (json) {
        //console.log(json);
        if (json&&json.error) {
            vm.$Message.error(json.error);
            // alert(json.msg);
    ...
    $.get(API('/env/setting/equip_locate/' + env_no), function (json) {
        if (json&&json.error) {
            vm.$Message.error(json.error);
            // alert(json.msg);
            return;
...
function load_relic(env_no, opt) {
    ...
    RELICS = {};
    $.get(API('/relic/setting/relic_type'), function (json) {
        if (json&&json.error) {
            vm.$Message.error(json.error);
            // alert(json.msg);
            return;
    ...
    $.get(API('/relic/setting/no_locate/' + vm.env_no), function (json) {
        if (json&&json.error) {
            vm.$Message.error(json.error);
            // alert(json.msg);
            return;
    ...
    $.get(API('/relic/setting/relic_locate/' + env_no), function (json) {
        if (json&&json.error) {
            vm.$Message.error(json.error);
            // alert(json.msg);
            return;
...
function save_locate(json) {
    ...
    var url;
    if (json.ty == 'equip') {
        url = API('/env/setting/save_locate');
    } else if (json.ty == 'relic') {
        url = API('/relic/setting/save_locate');
    } else {
        return;
    }
