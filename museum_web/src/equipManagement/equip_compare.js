...
module.exports = Vue.extend({
    ...
    methods:{
        ...
        getData:function(){
            ...
            $.get(API('/env/equipments/compare/compare_by_equip'),{equip_nos:this.equip_no_list.join(','),time:this.timeStr,index:this.index},function(data){
                // console.log(data);
                if(data.error){
