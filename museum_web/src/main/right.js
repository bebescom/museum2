...
exports.init = function () {
    ...
    $.get(API('/env/environments/homepage/hall_overview'), function (data) {
    ...
    $.get(API('/base/envs/fast_enter'), function (data) {
...
function getData() {
    ...
    $.get(API('/env/environments/homepage/overview_average/' + vm.th_btn), function (data) {
        myChart.hideLoading();
