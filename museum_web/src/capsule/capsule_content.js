// @require capsule/css/capsule_content.css
...
module.exports=Vue.extend({
	...
	methods:{
		...
		filter:function(env,name){
			...
			$.get(API('/env/box/box_lists/')+this.page+'/'+this.limit+this.env_no,function(data){
				console.log(data);
				This.arrList=[];
		...
		'equip':{
			...
			methods:{
				showAdd:function(env_no){
					...
					$.get(API('/env/box/box_alert/')+env_no,function(data){
						//console.log(data)
		...
		'remove-tooltip':{
			...
			methods:{
				...
				clearAleart:function(){
					var This=this;
					$.post(API('/env/box/clear_alert/')+this.data.env_no+'?remark='+this.text||'',function(data){
						// alert(data.msg);
...
function loading(){
	...
	var This=this;
	$.get(API('/env/box/box_lists/')+this.page+'/'+this.limit+this.env_no,function(data){
		//console.log(API('/env/box/box_lists/')+This.page+'/'+This.limit+This.env_no)
