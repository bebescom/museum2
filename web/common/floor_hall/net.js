define('common/floor_hall/net', function(require, exports, module) {
//
//
...
exports.init = function (env_no) {
    ...
    $.get('/2.2.05_P001/base_api/env/environments/networks/network_lists/' + env_no+'', function (data) {
