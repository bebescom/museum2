define('common/floor_hall/map', function(require, exports, module) {
//
//
var vm,
    $svg_map,
...
exports.init = function (env_no, opt) {
    ...
    // $('.sel_all').click();
    $.get('/2.2.05_P001/base_api/env/environments/legends/legend_classifies/' + env_no+'', function (data) {
        //权限全局判断
        //设置生成图例和页面同时控制
...
var get_legend_data = (function () {
    ...
    return function (env_no, legend, callback) {
        ...
        if (checkPermissions({name: '设备管理'}) || checkPermissions({name: '文物管理'})) {
            ...
            $.get('/2.2.05_P001/base_api/env/environments/legends/legend_detail/' + env_no + '/' + legend+'', function (data) {
                // console.log(data);
