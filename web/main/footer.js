define('main/footer', function(require, exports, module) {
// 
// 
// 
// 
...
function getScore() {
    ...
    $.get('/2.2.05_P001/base_api/env/environments/homepage/museum_scores', function (data) {
...
function getStandard() {
    $.get('/2.2.05_P001/base_api/env/environments/homepage/standard_params/' + vm.toggle_day+'', function (data) {
        if (data.total == 0) {
            return;
        }
