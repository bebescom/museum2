define('data.async/env_param', function (require, exports) {
    ...
    function getData(chart,time,fn) {
        ...
        $.get('/2.2.05_P001/base_api/env/environments/overviews/env_averages/' + select_hum+''+'?time='+(time?time:''), function (data) {
            console.log('/2.2.05_P001/base_api/env/environments/overviews/env_averages/' + select_hum+'')
