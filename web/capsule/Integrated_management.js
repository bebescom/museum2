define('capsule/Integrated_management', function(require, exports, module) {
// 
...
module.exports = {
    ...
    created: function () {
        ...
        $.get('/2.2.05_P001/base_api/env/general/envs/env_overview', function (data) {
            $('.shadow.wholeShadow').hide();
            if (data && data.error) {
            ...
            // console.log(data)
            //手动控制获取设备概况请求最后发出
            $.get('/2.2.05_P001/base_api/env/general/data/equip_count', function (data) {
                if (data && data.error) {
                    This.$Message.error(data.error);
                    return;
                }
        ...
        $.get('/2.2.05_P001/base_api/env/general/data/relic_count', function (data) {
            if (data && data.error) {
                This.$Message.error(data.error);
                return;
            }
        ...
        $.get('/2.2.05_P001/base_api/env/general/data/th_pole', function (data) {
            if (data && data.error) {
                This.$Message.error(data.error);
                return;
            }
        ...
        $.get('/2.2.05_P001/base_api/env/environments/overviews/weather/weathers', function (data) {
                if (data && data.error) {
                    This.$Message.error(data.error);
                    return;
                }
...
//$.get('/2.2.05_P001/base_api/base/envs/navigation/', function (data){
//})
    },
    ready: function () {
    ...
    methods: {
        ...
        Data_on: function (no, type) {
            console.log(no)
            var This = this;
            $.get('/2.2.05_P001/base_api/env/general/envs/all_envs_detail/' + no, function (data) {
                if (data && data.error) {
                    This.$Message.error(data.error);
                    return;
                }
        ...
        feedSubmit: function () {
            ...
            $.post('/2.2.05_P001/base_api/base/users/feedback/feedback_add', {'content': this.textareaVal}, function (data) {
                if (data && data.error) {
                    This.$Message.error(data.error);
                    return;
                }
        ...
        hrefFloor: function (name) {
            for (var key in this.partData) {
                if (this.partData[key].name == name) {
                    window.location.href = "../floor?env_no=" + this.partData[key].env_no+"";
                }
            }
        }
        ,
                ...
                methods:
                    {
                        ...
                        attention: function (env) {
                            var This = this;
                            $.post('/2.2.05_P001/base_api/base/users/active/active_add', {key: '关注', env_no: env}, function (data) {
                                // console.log(data)
                                if (data && data.error) {
                                    This.$Message.error(data.error);
                                    return;
                        ...
                        cancelAttention: function (env) {
                            var This = this;
                            $.post('/2.2.05_P001/base_api/base/users/active/follow_delete', {env_no: env}, function (data) {
                                if (data && data.error) {
                                    This.$Message.error(data.error);
                                    return;
                                }
                        ...
                        ,
                        browse: function (env) {
                            $.post('/2.2.05_P001/base_api/base/users/active/active_add', {key: '浏览', env_no: env}, function (data) {
                                if (data && data.error) {
                                    This.$Message.error(data.error);
                                    return;
                                }
                                window.location.href = "../hall?env_no=" + env+"";
                            });
