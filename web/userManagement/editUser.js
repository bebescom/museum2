define('userManagement/editUser', function(require, exports, module) {
...
module.exports = Vue.extend({
        ...
        data:function(params){
            ...
            $.get('/2.2.05_P001/base_api/base/roles',function(data){
                ...
                if(hash){
                    ...
                    me.userID = id;
                    //发出请求,查询用户为ID的用户
                    $.get('/2.2.05_P001/base_api/base/users/info/'+id+'',function(data){
                        console.log(data);
                        var obj = {
                            name: '',//登录名称username
                            nickname:'',//昵称tel
    ...
    methods:{
        handleSubmit:function(){
            ...
            $.post('/2.2.05_P001/base_api/base/users/edit/'+this.userID+'',sendParam,function(data){
                // console.log(data);
                if(data.msg==='修改成功!'){
