define('paramSetting/param_setting', function(require, exports, module) {
// 
// 
// 
// 
...
var vm = new Vue({
    ...
    ready:function(){
        var me = this;
        $.get('/2.2.05_P001/base_api/base/config/museum_config',function(data){
            if(data.error){
        ...
        //获取所有用户列表
        $.get('/2.2.05_P001/base_api/base/users',function (data) {
            if(data.error){
                me.$Message.error(data.error);
                return;
            }
        ...
        //获取二氧化碳监测终端设备
        $.get('/2.2.05_P001/base_api/env/equipments/manage/all_equip',{equip_type:'二氧化碳监测终端'},function (data) {
            me.carbon=data.rows;
            console.log(data)
        })
        //获取二氧化硫监测终端设备
        $.get('/2.2.05_P001/base_api/env/equipments/manage/all_equip',{equip_type:'二氧化硫监测终端'},function (data) {
            me.sulfur=data.rows;
            console.log(data)
        })
        //获取氮氧化物监测终端设备
        $.get('/2.2.05_P001/base_api/env/equipments/manage/all_equip',{equip_type:'氮氧化物监测终端'},function (data) {
            me.nitrogen=data.rows;
            console.log(data)
        })
        //获取臭氧监测终端设备
        $.get('/2.2.05_P001/base_api/env/equipments/manage/all_equip',{equip_type:'臭氧监测终端'},function (data) {
            me.ozone=data.rows;
            console.log(data)
        })
    ...
    methods:{
        ...
        saveHandler:function(){
            ...
            $.post('/2.2.05_P001/base_api/base/config/edit',this.configObj,function(res){
                console.log(res)
                if(res.msg!=='修改成功'){
