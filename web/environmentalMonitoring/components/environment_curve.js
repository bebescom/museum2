define('environmentalMonitoring/components/environment_curve', function(require, exports, module) {
...
module.exports = {
    ...
    methods: {
        ...
        submitEdit: function (env_no) {//先对输入验证情况进行判断
            ...
            $.post('/2.2.05_P001/base_api/env/common/threshold/add_edit', postObj, function (data) {
                    if (data.result) {
        ...
        getEnvThresholdData: function () {
            ...
            me.envThresholdData = {};
            this.thresholdIndex++;
            $.get('/2.2.05_P001/base_api/env/common/threshold/' + this.envs + '/env', {index: this.thresholdIndex}, function (data) {
        ...
        changeLockStatus: function (env_no) {//点击上锁或者开锁事件
            ...
            if (this.envThresholdData[env_no].lock == 0) {//当前状态为解锁
                ...
                $.post('/2.2.05_P001/base_api/env/common/threshold/lock/' + env_no + '/1', function (data) {
                        if (data.result) {
                ...
                me.envThresholdData[env_no].lock = 0;//页面展示效果修改
                $.post('/2.2.05_P001/base_api/env/common/threshold/lock/' + env_no + '/0', function (data) {
                        if (data.result) {
        ...
        init_env_charts: function () {
            ...
            $.get('/2.2.05_P001/base_api/env/monitor/line', {env_no: This.envs, time: this.time, index: this.index,alert_time: This.alertTimeA,alert_param:This.alert_param}, function (data) {
                console.log(data)
        ...
        get_eigenvalue: function () {			//获取特征值
            ...
            // }
            this.index1++;
            $.get('/2.2.05_P001/base_api/env/monitor/monitor_statistic', {
                    env_no: this.envs,
                    time: this.time,
