define('environmentalMonitoring/components/environment_data', function(require, exports, module) {
//获取参数单位名称
...
module.exports={
	...
	methods:{
		...
		getData:function(){
			...
			setTimeout(function(){
				$.get('/2.2.05_P001/base_api/env/monitor/data_table',This.data_params,function(data){
					This.$shadow.hide();
