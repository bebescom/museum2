    ...
    Vue.component('ping', {
        ...
        methods: {
            ping: function () {
                ...
                _this.ping_data = '';
                _this.spinShow = true;
                $.get("/2.2.05_P001/base_api/env/equipments/operation/ping/" + _this.equip_info.equip_no+"", function (data) {
    ...
    Vue.component('equip-left', {
        ...
        methods: {
            ...
            get_env_equip: function () {
                ...
                $.get('/2.2.05_P001/base_api/env/environments/cabinet/equips/' + _this.equip_info.env_no+'', function (data) {
                    var similar_equip = [];
            ...
            get_env_relic: function () {
                ...
                //获取同柜藏品
                $.get('/2.2.05_P001/base_api/env/environments/cabinet/relics/' + _this.equip_info.env_no+'', function (data) {
            ...
            get_img: function () {
                var _this = this;
                $.get('/2.2.05_P001/base_api/env/equipments/images' + '?no=' + _this.equip_info.equip_no, function (data) {
                    if (!data.rows || data.rows.length === 0) return;
            ...
            get_router: function () {
                ...
                $.get('/2.2.05_P001/base_api/env/equipments/detail/branch/' + _this.equip_info.equip_no+'', function (data) {
                    if (!data.rows || data.rows.length === 0) return;
            ...
            save_target: function () {
                ...
                $.post('/2.2.05_P001/base_api/env/equipments/setting', {settings: [setting]}, function (data) {
                    if (data.error) {
            ...
            del_img: function (id) {
                ...
                layer.confirm('确认删除', {btn: ['删除', '取消']}, function (index) {
                    $.post('/2.2.05_P001/base_api/env/equipments/images/del_images', {id: id}, function (data) {
                        _this.get_img();
                    });
                    layer.close(index);
                });
