define('equipManage/equip_alert', function(require, exports, module) {
var vm;
var searchParam = {
    index: 0,
    page: 1,
...
function filter_data() {
    ...
    $.get('/2.2.05_P001/base_api/env/equipments/alerts/alert_count', function (data) {
...
function getEquipList(search_data) {
    ...
    console.log(param);
    $.get('/2.2.05_P001/base_api/env/equipments/alerts/alert_list', param, function (data) {
