define('relicManagement/relicsCheck', function(require, exports, module) {
// 
// 
...
module.exports = {
    ...
    methods:{
        ...
        getData:function(){
            var me = this;
            $.get('/2.2.05_P001/base_api/relics/inventorytask/list/'+this.page+'/'+this.limit+''+'?requestType=pc',function(res){
                // console.log(res);
