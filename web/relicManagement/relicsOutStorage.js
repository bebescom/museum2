define('relicManagement/relicsOutStorage', function(require, exports, module) {
// 
// 
module.exports = {
    ...
    methods:{
        out_storage_ok:function(){
            ...
            if(this.selRelics&&this.selRelics.length!==0){
                if(!this.status){
                    ...
                    $.ajax({
                        type:"POST",
                        url:'/2.2.05_P001/base_api/relics/outstockRecord/outstock'+'?requestType=pc',
        ...
        getRelic:function(filterObj){
            ...
            $.ajax({
                type:'GET',
                url:'/2.2.05_P001/base_api/relics/outstockRecord/relic/list/'+this.page+'/'+this.limit+'',
                data:this.filter,
                error:function(XMLHttpRequest, textStatus, errorThrown){
