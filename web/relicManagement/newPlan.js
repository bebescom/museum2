define('relicManagement/newPlan', function(require, exports, module) {
// 
// 
...
module.exports = {
    ...
    methods:{
        ...
        okHandler:function(){
            ...
            this.$Modal.confirm({
                ...
                onOk:function(){
                    ...
                    $.ajax({
                        type:'POST',
                        url:"/2.2.05_P001/base_api/relics/inventorytask/initiate"+'?requestType=pc',
        ...
        getUserList:function(){
            var me = this;
            $.get('/2.2.05_P001/base_api/relics/user/list'+'?requestType=pc',function(res){
                // console.log(res);
                if(res.error_code!==0){
                    me.$Message.error(res.message);
                    return ;
        ...
        getRelic:function(filterObj){
            ...
            $.get('/2.2.05_P001/base_api/relics/relic/list/'+this.page+'/'+this.limit+'',this.filter,function(res){
