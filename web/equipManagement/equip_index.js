define('equipManagement/equip_index', function(require, exports, module) {
...
module.exports = Vue.extend({
    ...
    methods: {
        ...
        getEquipList: function(){//获取设备列表数据
            ...
            $.get('/2.2.05_P001/base_api/env/equipments/manage/equip_list',this.equipListParam,function(data){
                console.log(data);
