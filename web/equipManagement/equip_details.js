define('equipManagement/equip_details', function(require, exports, module) {
// 
// 
// 
// 
...
module.exports = Vue.extend({
    ...
    route: {
        data: function (transition) {
            ...
            if (arr[1] == 'equip_no') {
                $.get('/2.2.05_P001/base_api/env/equipments/detail/detail_info/' + params.equip_no, function (data) {//同柜设备跳转时equip_no 使用params保存的no
                ...
                $.get('/2.2.05_P001/base_api/env/equipments/detail/detail_info/' + equip_test, function (data) {//列表中进入使用sessionStorage保存的no
                    _this.equip_name = data.name;
                    _this.collection_info = data;
                    _this.env_no = data.env_no;
                    _this.equip_type = data.equip_type;
    ...
    methods: {
        ...
        getLink: function () {
            var me = this;
            $.post('/2.2.05_P001/base_api/env/export/equipment/equip_data', {
                ...
                window.location = '/2.2.05_P001/base_api' + '/' + data[0].url;
            })
        },
        ...
        'left-information': {
            ...
            methods: {
                ...
                getSelectedNodes: function (newClickVal) {//修改位置
                    var _this = this;
                    $.get('/2.2.05_P001/base_api/base/envs/tree', function (data) {//查找对应点击菜单的环境编号
                        for (var i in data) {
                ...
                setInformation: function (data) {//设置左边栏信息数据
                    ...
                    this.url = '/2.2.05_P001/base_apibase/upload';
                    if (data && data.env_no) {
                        $.get("/2.2.05_P001/base_api/env/environments/cabinet/equips/" + data.env_no+"", function (data) {//设置同柜设备数据
                            var len,
                                equip_arr = [];
                        ...
                        $.get('/2.2.05_P001/base_api/env/environments/cabinet/relics/' + data.env_no+'', function (data) {//设置同柜藏品数据
                            if (data.length = 0) {
                                _this.relic_arr = '';
                ...
                ok: function () {//点击确定确认修改
                    ...
                    $.post('/2.2.05_P001/base_api/env/equipments/manage/edit', {
                    ...
                    watch: {
                        collection_info: function (newVal, oldVal) {//设备更换
                            ...
                            if (newVal != oldVal || newVal.equip_no) {
                                ...
                                $.get('/2.2.05_P001/base_api/env/equipments/detail/statistic', {
                    ...
                    methods: {
                        ...
                        showChart: function (key) {//显示对应曲线
                            ...
                            if (_this.axisVal === null) {
                                $.get('/2.2.05_P001/base_api/env/equipments/param_lines/' + this.equip_id + '/' + this.time, function (data) {
                                    _this.axisVal = data;
                                ...
                                if (_this.timeChange === true) {
                                    ...
                                    $.get('/2.2.05_P001/base_api/env/equipments/param_lines/' + this.equip_id + '/' + _this.time, function (data) {
                                        _this.axisVal = data;
                                        _this.equipEcharts(data);
                                    });
                                } else {
                ...
                'equip_original': {//原始数据
                    ...
                    methods: {
                        ...
                        getData: function () {
                            ...
                            setTimeout(function () {
                                $.get('/2.2.05_P001/base_api/env/equipments/data_lists/' + _this.collection_info.equip_no, _this.data_params, function (data) {
                        ...
                        initData: function () {//初始化表格数据（原始数据）
                            ...
                            $.get('/2.2.05_P001/base_api/env/equipments/data_lists/' + _this.collection_info.equip_no, this.data_params, function (data) {
                                if ('rows' in data) {
                                    _this.table_data = data;
                                    _this.showhas = true;
                                } else {
                ...
                'equip_history': {//历史信息
                    ...
                    methods: {
                        ...
                        getData: function () {
                            ...
                            this.data_params.index++;
                            setTimeout(function () {
                                $.get('/2.2.05_P001/base_api/env/equipments/detail/opt_record/' + _this.collection_info.equip_no, _this.data_params, function (data) {
                                    _this.table_data = data;
                                    _this.data_params.index = 0;
                                    $('.scrollWrap .body>.shadow').hide();
                                });
