define('equipManagement/alert_list', function(require, exports, module) {
// 
// 
// 
// 
...
var vm = new Vue({
    ...
    ready:function(){
        ...
        $.post('/2.2.05_P001/base_api/base/users/active/alert_activity',{alert_type:"equip"},function(res){
            if(!res.result){
    ...
    methods:{
        ...
        getData:function(filterObj){
            ...
            $.get('/2.2.05_P001/base_api/env/equipments/alerts/alert_list',queryObj,function(res){
                // console.log(res);
