define('equipManagement/components/send_down', function(require, exports, module) {
// 
// 
var default_param = {
    model: '休眠',
...
exports.send_down = Vue.extend({
    ...
    ready: function () {
        ...
        $.get('/2.2.05_P001/base_api/env/equipments/equip_lists', function (data) {
            if (data.error) {
    ...
    methods: {
        ...
        submitModify: function () {
            ...
            if (this.sel_equip_no_list && this.sel_equip_no_list.length !== 0) {
                ...
                // console.log(result);
                $.post('/2.2.05_P001/base_api/env/equipments/edits/edit_multi', {data: result}, function (data) {
        ...
        save: function () {
            ...
            $this.$Loading.start();
            $.post('/2.2.05_P001/base_api/env/datas/data_send_down/save', json, function (data) {
                $this.$Loading.finish();
                if (data.error) {
        ...
        get_history: function () {
            ...
            $this.$Loading.start();
            $.get('/2.2.05_P001/base_api/env/datas/data_send_down/send_down_list' + query, function (data) {
                $this.$Loading.finish();
                if (data.error) {
                    $this.$Message.error(data.error);
                    return;
