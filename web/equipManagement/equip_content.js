define('equipManagement/equip_content', function(require, exports, module) {
// 
// 
// 
// 
...
var send_down=require('equipManagement/components/send_down');
...
module.exports = Vue.extend({
    ...
    ready: function () {
        ...
        $.get('/2.2.05_P001/base_api/env/equipments/equip_parameters',function(data){
            //console.log(data);
    ...
    methods: {
        ...
        removeArr: function () {
            ...
            var This = this;
            $.post('/2.2.05_P001/base_api/env/equipments/manage/delete/' + this.sel_equip_no_list.join(','), function (data) {
                // This.select=false;
                This.sel_equip_no_list = [];
                This.resetTurnPage(This.page);
            });
        ...
        get_data:function(filterObj){
            ...
            $.get('/2.2.05_P001/base_api/env/equipments/manage/equip_list',queryObj, function (data) {
        ...
        //     this.$shadow.show();
        //     $.get('/2.2.05_P001/base_api/env/equipments/manage/equip_list' + key, function (data) {
		...
		'add-data':{
			...
			methods:{
				...
				continueOver:function(key){
					...
					this.dataKey=false;
					$.post('/2.2.05_P001/base_api/env/equipments/manage/equip_add',this.addData,function(data){
					    if(data.error){
                ...
                typeSelect: function () {										//设备类型变化时改变addData.equip_type
                    var This = this;
                    $.get('/2.2.05_P001/base_api/env/equipments/manage/code', {equip_type: this.addData.equip_type}, function (data) {
                        // console.log(data);
